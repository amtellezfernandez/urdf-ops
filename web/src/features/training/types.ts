...
export interface TrainingRuntimeDependencyStatus {
  name: string;
  required: boolean;
  installed: boolean;
  version?: string;
...
export interface TrainingRuntimeCheckResponse {
  available: boolean;
  pythonExecutable: string;
  dependencies: TrainingRuntimeDependencyStatus[];
  cudaAvailable?: boolean;
  message: string;
}

export interface TrainingComputeBackendCapability {
  type: string;
  label: string;
  enabled: boolean;
...
export interface TrainingComputeBackendsResponse {
