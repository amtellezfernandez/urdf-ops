...
MODEL_ARCHITECTURES: Dict[str, ModelArchitectureInfo] = {
    ...
    "lereal_world_model": ModelArchitectureInfo(
        name="lereal_world_model",
        display_name="LeRealWorldModel (JEPA + GC-IDM)",
        description=(
            "Two-stage latent world-model post-training for LeRobot datasets: Stage 1 trains a JEPA "
            "world model and Stage 2 can train/export a GC-IDM goal-conditioned planner."
        ),
        default_config={
        ...
        config_schema={
            ...
            "stage1_config": {"type": "string"},
            "stage2_config": {"type": "string"},
            "run_stage2": {"type": "bool"},
            "export_policy": {"type": "bool"},
            "image_key": {"type": "string"},
            "image_key2": {"type": "string"},
            "frameskip": {"type": "int", "min": 1, "max": 30},
            "action_dim": {"type": "int", "min": 1, "max": 64},
            "stage1_epochs": {"type": "int", "min": 1, "max": 1000},
            "stage2_steps": {"type": "int", "min": 1, "max": 1000000},
            "goal_image_path": {"type": "string"},
        },
        recommended_for=[
            "world-model post-training",
            "goal-conditioned manipulation",
            "SO-100/SO-101 image datasets",
        ],
    ),
